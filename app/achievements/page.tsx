...
function formatUnlockDate(value: string | null) {
  return value ? new Intl.DateTimeFormat("es-CR", { dateStyle: "medium" }).format(new Date(value)) : null;
}
